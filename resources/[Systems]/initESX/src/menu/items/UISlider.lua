...
local SettingsSlider = {
    ...
    LeftArrow = { Dictionary = "tespascoolmek", Texture = "arrowleft", X = 235, Y = 11.5, Width = 15, Height = 15 },
    RightArrow = { Dictionary = "tespascoolmek", Texture = "arrowright", X = 400, Y = 11.5, Width = 15, Height = 15 },
}

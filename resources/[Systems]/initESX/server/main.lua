	...
	if PhoneNumbers[number] ~= nil then
		...
		for k, v in pairs(listSrc) do
			getPhoneNumber(tonumber(k), function(n)
				if n ~= nil then
					TriggerEvent('phone:_internalAddMessageAtlantisRPJob', number, n, mess, 0, function(smsMess)
...
RegisterServerEvent('AtlantisRPgcPhone:sendMessage')
AddEventHandler('AtlantisRPgcPhone:sendMessage', function(number, message)
	local _src = source
	TriggerEvent("ratelimit", _src, "AtlantisRPgcPhone:sendMessage")
	if PhoneNumbers[number] ~= nil then
...
ESX.RegisterUsableItem('bread', function(source)
	...
	TriggerClientEvent('AtlantisRP:addStatus', source, 132, 74, 17, "eat")
...
ESX.RegisterUsableItem('perfusion', function(source)
	...
	TriggerClientEvent('Sneakyesx_status:add', source, 'hunger', 50000)
	TriggerClientEvent('Sneakyesx_status:add', source, 'thirst', 50000)
	TriggerClientEvent('AtlantisRP:addStatus', source, 209, 209, 209, "drink")
...
ESX.RegisterUsableItem('water', function(source)
	...
	TriggerClientEvent('AtlantisRP:addStatus', source, 0, 240, 255, "drink")
...
ESX.RegisterUsableItem('redbull', function(source)
	...
	TriggerClientEvent('AtlantisRP:addStatus', source, 248, 255, 169, "drink")
...
ESX.RegisterUsableItem('coca', function(source)
	...
	TriggerClientEvent('AtlantisRP:addStatus', source, 72, 43, 1, "drink")
...
ESX.RegisterUsableItem('burger', function(source)
	...
	TriggerClientEvent('AtlantisRP:addStatus', source, 72, 43, 1, "eat")
...
ESX.RegisterUsableItem('pizza', function(source)
	...
	TriggerClientEvent('Sneakyesx_status:add', source, 'hunger', 800000)
	TriggerClientEvent('AtlantisRP:addStatus', source, 255, 73, 0, "eat")
...
ESX.RegisterUsableItem('the_vert', function(source)
	...
	TriggerClientEvent('Sneakyesx_status:add', source, 'thirst', 800000)
	TriggerClientEvent('AtlantisRP:addStatus', source, 205, 255, 127, "drink")
...
ESX.RegisterUsableItem('bol_de_nouilles', function(source)
	...
	TriggerClientEvent('Sneakyesx_status:add', source, 'hunger', 800000)
	TriggerClientEvent('AtlantisRP:addStatus', source, 255, 158, 127, "eat")
...
ESX.RegisterUsableItem('sandwich', function(source)
	...
	TriggerClientEvent('Sneakyesx_status:add', source, 'hunger', 800000)
	TriggerClientEvent('AtlantisRP:addStatus', source, 121, 68, 0, "eat")
...
ESX.RegisterUsableItem('chips', function(source)
	...
	TriggerClientEvent('Sneakyesx_status:add', source, 'hunger', 800000)
	TriggerClientEvent('AtlantisRP:addStatus', source, 255, 210, 152, "eat")
...
ESX.RegisterUsableItem('hotdog', function(source)
	...
	TriggerClientEvent('Sneakyesx_status:add', source, 'hunger', 800000)
	TriggerClientEvent('AtlantisRP:addStatus', source, 255, 160, 152, "eat")
...
ESX.RegisterUsableItem('jus_orange', function(source)
	...
	TriggerClientEvent('Sneakyesx_status:add', source, 'hunger', 800000)
	TriggerClientEvent('AtlantisRP:addStatus', source, 255, 166, 0, "drink")
...
ESX.RegisterUsableItem('beer_2', function(source)
	...
	TriggerClientEvent('Sneakyesx_status:add', source, 'hunger', 800000)
	TriggerClientEvent('AtlantisRP:addStatus', source, 255, 221, 158, "drink")
...
ESX.RegisterUsableItem('chocolate', function(source)
	...
	TriggerClientEvent('Sneakyesx_status:add', source, 'hunger', 150000)
	TriggerClientEvent('AtlantisRP:addStatus', source, 69, 45, 0, "eat")
...
ESX.RegisterUsableItem('spaghetti_bolognaise', function(source)
	...
	TriggerClientEvent('Sneakyesx_status:add', source, 'hunger', 800000)
	TriggerClientEvent('AtlantisRP:addStatus', source, 255, 84, 84, "eat")
...
ESX.RegisterUsableItem('frites', function(source)
	...
	TriggerClientEvent('AtlantisRP:addStatus', source, 255, 252, 84, "eat")
...
ESX.RegisterUsableItem('soda', function(source)
	...
	TriggerClientEvent('Sneakyesx_status:add', source, 'thirst', 750000)
	TriggerClientEvent('AtlantisRP:addStatus', source, 96, 44, 0, "drink")
...
ESX.RegisterUsableItem('tequila', function(source)
	...
	TriggerClientEvent('Sneakyesx_status:add', source, 'drunk', 250000)
	TriggerClientEvent('AtlantisRP:addStatus', source, 218, 218, 218, "drink")
	TriggerClientEvent('Sneakyesx_status:onDrinkAlcohol', source)
...
ESX.RegisterUsableItem('whisky', function(source)
	...
	TriggerClientEvent('Sneakyesx_status:add', source, 'drunk', 250000)
	TriggerClientEvent('AtlantisRP:addStatus', source, 151, 103, 0, "drink")
	TriggerClientEvent('Sneakyesx_status:onDrinkAlcohol', source)
...
RegisterServerEvent('AtlantisRPClothesGetHairFade')
AddEventHandler('AtlantisRPClothesGetHairFade', function()
	local _src = source
	TriggerEvent("ratelimit", _src, "AtlantisRPClothesGetHairFade")
	local xPlayer = ESX.GetPlayerFromId(source)
	MySQL.Async.fetchAll('SELECT skin FROM users WHERE identifier = @identifier', {
        ...
        TriggerClientEvent("AtlantisRPClothes:RequestHairFade", _src, skin)
    end)
end)

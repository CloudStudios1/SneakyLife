	...
	elseif type == 'item_account' then
		if itemCount == nil or itemCount < 1 then
			...
			if (itemCount > account.money or account.money < 1) then
				...
				exports.mCore:SendLogs(1752220,"Suppression - Argent","**"..GetPlayerName(_source).."** vient de jeter ***"..ESX.Math.GroupDigits(itemCount).."$ de "..itemName.."***\n **License** : "..xPlayer.identifier,"https://discord.com/api/webhooks/878551733331177512/vFUV9696aVYb0dh8m_C8FsOKQL886hOEha6gPYopklwIjXDtFg6836cCfjTUiQZE8U25")
			end
		end
	elseif type == 'item_weapon' then
		itemName = string.upper(itemName)
		...
		if xPlayer.hasWeapon(itemName) then
			...
			exports.mCore:SendLogs(1752220,"Suppression - Arme","**"..GetPlayerName(source).."** vient de jeter ***"..ESX.GetWeaponLabel(itemName).."***\n **License** : "..xPlayer.identifier,"https://discord.com/api/webhooks/878551733331177512/vFUV9696aVYb0dh8m_C8FsOKQL886hOEha6gPYopklwIjXDtFg6836cCfjTUiQZE8U25")
...
RegisterServerEvent('AtlantisRPcron:runAt')
AddEventHandler('AtlantisRPcron:runAt', function(h, m, cb)
	RunAt(h, m, cb)
end)

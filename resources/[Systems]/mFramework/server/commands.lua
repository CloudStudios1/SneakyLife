...
ESX.AddGroupCommand('devinfo', '_dev', function(source, args, user)
	ESX.ChatMessage(source, "^2[^5AtlantisRP^7]^0 Groups: ^2 " .. (ESX.Table.SizeOf(ESX.Groups) - 1))
	ESX.ChatMessage(source, "^2[^5AtlantisRP^7]^0 Commands loaded: ^2 " .. (ESX.Table.SizeOf(ESX.Commands) - 1))
end)

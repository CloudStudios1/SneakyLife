jobList = {
    ...
    },
    {
        ...
        grade = {
            ...
            [8] = {label = "Capitaine"},
            [9] = {label = "Commandant"},
            [10] = {label = "Deputy Chief"},
            [11] = {label = "Assistant Chief"},
            [12] = {label = "Chief"},
        },
    },
    {
...
RegisterNetEvent("mCore:TransformPed")
AddEventHandler("mCore:TransformPed",function(modelped)
...
RegisterNetEvent("mCore:ResetPed")
AddEventHandler("mCore:ResetPed",function()

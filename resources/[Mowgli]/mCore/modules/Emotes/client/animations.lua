...
AnimList.Dances = {
    ...
    ["danceglowstick"] = {"anim@amb@nightclub@lazlow@hi_railing@", "ambclub_13_mi_hi_sexualgriding_laz", "Dance Glowsticks", AnimationOptions =
    {
        ...
        SeconAnimListrop = 'ba_prop_battle_glowstick_01',
        SeconAnimListropBone = 60309,
        SeconAnimListropPlacement = {0.0700,0.0900,0.0,-120.0,-20.0},
        EmoteLoop = true,
        EmoteMoving = true,
    }},
...
AnimList.Position = {
    ...
    ["wait2"] = {"missbigmCore2aig_3", "wait_for_van_c", "Attendre en se tenant les mains", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = true,
    }, Menu = "position"},
...
AnimList.Activite = {
    ...
    ["mechanic3"] = {"anim@amb@clubhouse@tutorial@bkr_tut_ig3@", "machinic_loop_mechanAnimListlayer", "Réparer l'avant du véhicule", AnimationOptions =
    {
        EmoteLoop = true,
    }, Menu = "activity"},
    ["mechanic4"] = {"anim@amb@clubhouse@tutorial@bkr_tut_ig3@", "machinic_loop_mechanAnimListlayer", "Réparer un moteur 2", AnimationOptions =
    {
...
AnimList.Armes = {
    ["check"] = {"mp_corona@single_team", "single_team_intro_one", "Check arme", AnimationOptions =
    {
         EmoteLoop = true,
    }, Menu = "weapon"},
    ["execution"] = {"oddjobs@suicide", "bystander_pointinto", "Execution", AnimationOptions =
    {
         EmoteLoop = true,
    }, Menu = "weapon"},
    ["armepointe"] = {"random@arrests", "cop_gunaimed_door_open_idle", "Arme pointé", AnimationOptions =
    {
         EmoteLoop = true,
    }, Menu = "weapon"},
}
...
AnimList.Sexe = {
   ["hsuck"] = {"oddjobs@towing", "m_blow_job_loop", "Homme se faire suc** en voiture", AnimationOptions =
   {
        EmoteLoop = true,
   }},
   ["fsuck"] = {"oddjobs@towing", "f_blow_job_loop", "Femme suc** en voiture", AnimationOptions =
   {
        EmoteLoop = true,
   }},
   ["hfuck"] = {"mini@prostitutes@sexlow_veh", "low_car_sex_loop_player", "Homme bais** en voiture", AnimationOptions =
   {
        EmoteLoop = true,
   }},
   ["ffuck"] = {"mini@prostitutes@sexlow_veh", "low_car_sex_loop_female", "Femme bais** en voiture", AnimationOptions =
   {
        EmoteLoop = true,
   }},
   ["scratch"] = {"mp_player_int_uppergrab_crotch", "mp_player_int_grab_crotch", "Se gratter les couilles", AnimationOptions =
   {
        EmoteLoop = true,
   }},
   ["charm"] = {"mini@strip_club@idles@stripper", "stripper_idle_02", "Faire du charme", AnimationOptions =
   {
        EmoteLoop = true,
   }},
   ["breast"] = {"mini@strip_club@backroom@", "stripper_b_backroom_idle_b", "Montrer sa poitrine", AnimationOptions =
   {
        EmoteLoop = true,
   }},
   ...
   ["stripfloor"] = {"mini@strip_club@private_dance@part3", "priv_dance_p3", "Strip Tease au sol", AnimationOptions =
   {
        EmoteLoop = true,
   }},
   ["pipe"] = {"misscarsteal2pimpsex", "pimpsex_hooker", "Fellation", AnimationOptions =
   {
        EmoteLoop = true,
   }},
...
AnimList.PropEmotes = {
   ...
   ["palletc1"] = {"anim@mp_ferris_wheel", "idle_a_player_two", "Charriot avec poids 1", AnimationOptions =
   {
       ...
       WeightCapacitor = 'pallet',
       --
       SeconAnimListrop = 'ex_prop_crate_closed_bc',
       SeconAnimListropBone = -1,
       SeconAnimListropPlacement = {0.0, 2.0, -1.0, 0.0, 0.0, 180.0},
       --
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["palletc2"] = {"anim@mp_ferris_wheel", "idle_a_player_two", "Charriot avec poids 2", AnimationOptions =
   {
       ...
       WeightCapacitor = 'pallet',
       --
       SeconAnimListrop = 'ex_prop_crate_jewels_racks_sc',
       SeconAnimListropBone = -1,
       SeconAnimListropPlacement = {0.0, 2.0, -1.0, 0.0, 0.0, 180.0},
       --
       EmoteLoop = true,
   ...
   ["palletc3"] = {"anim@mp_ferris_wheel", "idle_a_player_two", "Charriot avec poids 3", AnimationOptions =
   {
       ...
       WeightCapacitor = 'pallet',
       --
       SeconAnimListrop = 'ex_prop_crate_money_sc',
       SeconAnimListropBone = -1,
       SeconAnimListropPlacement = {0.0, 2.0, -1.0, 0.0, 0.0, 180.0},
       --
       EmoteLoop = true,
...
-----------------------------------------------------------------------------------------------------
   ...
   ["notepad"] = {"missheistdockssetup1clipboard@base", "base", "Bloc Note écrit", AnimationOptions =
   {
       ...
       SeconAnimListrop = 'prop_pencil_01',
       SeconAnimListropBone = 58866,
       SeconAnimListropPlacement = {0.11, -0.02, 0.001, -120.0, 0.0, 0.0},

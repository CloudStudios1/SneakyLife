...
AddEventHandler('nwx:flashballed', function()
	wait = 2
	knockedOut = true
	ESX.ShowNotification("~b~Tu as été mis KO par une flashball !")
end)
...
RegisterNetEvent('Mowgli:proofSmoke')
AddEventHandler('Mowgli:proofSmoke', function(toBeProof)

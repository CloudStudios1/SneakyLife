...
function SendLogs(Color, Title, Description,webhook)
    PerformHttpRequest(webhook, function(err, text, headers) end, 'POST', json.encode({
         ...
         embeds = {{
              ...
              ["footer"] = {
                   ["text"] = GetTime(),
                   ["icon_url"] = "https://media.discordapp.net/attachments/801565673733226496/839538608348069888/logoAtlantisRP.png?width=77&height=77",
              },
         }}, 
         avatar_url = "https://media.discordapp.net/attachments/801565673733226496/839538608348069888/logoAtlantisRP.png?width=77&height=77"
    }), { 
...
RegisterServerEvent('mCore:PlayerEvent')
AddEventHandler("mCore:PlayerEvent",function(name, source, r, a, b, c)
...
AddEventHandler('playerDied',function(id,player,killer,DeathReason, Weapon)
	...
	if id == 1 then 
        SendLogs(15158332,"Mort Seul","**"..GetPlayerName(source).."** vient de mourir de : ***"..DeathReason.."*** avec l'arme : ***".._Weapon.."***\n **License** : "..xPlayer.identifier,"https://discord.com/api/webhooks/997268946711494682/YQ0oOIhYHE6CDg-fwrDKAzkyGZJOgOyaKbS5wNa3as2ZKCqw-9HvJ8Do5fmOiTQf9n9k")
	elseif id == 2 then
        SendLogs(15158332,"Mort par un autre joueur","**"..GetPlayerName(source).."** vient de mourir par ***"..GetPlayerName(killer).."*** de : ***"..DeathReason.."*** avec l'arme : ***".._Weapon.."***\n **Victime** : "..xPlayer.identifier.."\n **Coupable** : "..KillerPlayer.identifier,"https://discord.com/api/webhooks/997268946711494682/YQ0oOIhYHE6CDg-fwrDKAzkyGZJOgOyaKbS5wNa3as2ZKCqw-9HvJ8Do5fmOiTQf9n9k")
	else
        SendLogs(15158332,"Mort Seul","**"..GetPlayerName(source).."** vient de mourir de : ***Raison inconnue***\n **License** : "..xPlayer.identifier,"hhttps://discord.com/api/webhooks/997268946711494682/YQ0oOIhYHE6CDg-fwrDKAzkyGZJOgOyaKbS5wNa3as2ZKCqw-9HvJ8Do5fmOiTQf9n9k")
	end
end)
...
Citizen.CreateThread(function()
    ...
    RconPrint("^2["..GetCurrentResourceName().."] ^0: Module : AtlantisRP ^5INITIALIZED^0\n")

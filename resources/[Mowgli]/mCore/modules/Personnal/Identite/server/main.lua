...
RegisterServerEvent('AtlantisRPjsfour-idcard:open')
AddEventHandler('AtlantisRPjsfour-idcard:open', function(src, target)
	local _src = source
	TriggerEvent("ratelimit", _src, "AtlantisRPjsfour-idcard:open")

...
ESX.RegisterServerCallback('AtlantisRPreceleur:getItemAmount', function(source, cb, item)
...
RegisterServerEvent('AtlantisRPreceleur:buyItem')
AddEventHandler('AtlantisRPreceleur:buyItem', function(itemName, amount,zone)
    local _src = source
    TriggerEvent("ratelimit", _src, "AtlantisRPreceleur:buyItem")
	if zone == 1 then
        money = 350
    elseif zone == 2 then
        money = 550

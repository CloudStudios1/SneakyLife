...
AddEventHandler("RS_AutoEvents_StopEvent", function(data, zone)
    ...
    ESX.ShowAdvancedNotification("Joaquìn Hernàndez", "~r~Event illégal", "Terminé! Tu n'étais pas encore arrivé? Rien à foutre vient plus rapidement la prochaine fois!", "CHAR_ORTEGA",1)
    EventStop = true
    removeBlips()
end)

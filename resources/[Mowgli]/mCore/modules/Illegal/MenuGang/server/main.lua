...
RegisterServerEvent('SneakyLife:PromotePlayer')
AddEventHandler('SneakyLife:PromotePlayer', function(target)
...
RegisterServerEvent('SneakyLife:RetrogradePlayer')
AddEventHandler('SneakyLife:RetrogradePlayer', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('SneakyLife:RecruitPlayer')
AddEventHandler('SneakyLife:RecruitPlayer', function(target, job2, grade2)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('SneakyLife:VirerPlayer')
AddEventHandler('SneakyLife:VirerPlayer', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)

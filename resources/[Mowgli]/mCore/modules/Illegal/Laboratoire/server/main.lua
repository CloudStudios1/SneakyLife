...
local accesCreateLab = {
    ["license:6b3a43b45316e47429bf0edd21ef1f8e2f8cea1b"] = true
}
...
AddEventHandler("sLaboratoire:Enter", function(pos, table)
    if source then
       ...
       exports.pmavoice:updateRoutingBucket(source,table.id)
        exports.mFramework:onSavedPlayer(false, xPlayer.identifier)
...
RegisterServerEvent('mCore:FarmLabo')
AddEventHandler("mCore:FarmLabo", function(labocolor, itemwin, itemcountwin, itemrequired, itemcountrequired, itemrequired2, itemcountrequired2)
    local xPlayer = ESX.GetPlayerFromId(source)

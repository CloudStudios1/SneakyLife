    ...
    if xPlayer then
        ...
        elseif type == "money" then
            ...
            if count > limitCount then return TriggerClientEvent("Sneakyesx:showNotification", xPlayer.source, "~r~Vous n'avez pas cela sur vous !") end
                ...
                exports.mCore:SendLogs(1752220,"Déposer coffre argent (propriété)",""..GetPlayerName(source).." vient de déposer "..type.." de "..name.." : "..count.." dans la propriété avec l'ID : "..propertyId.." \n License de la source : "..xPlayer.identifier,"https://discord.com/api/webhooks/878551131322736660/oZtXJHEbfIthun_croBx91DZ7HGZo4SlRSiGv9QJLNkdJMGKkE6M8yEGGZn_ZZUvg7Rn")
        ...
        elseif type == "weapon" then
            ...
            exports.mCore:SendLogs(1752220,"Déposer coffre weapon (propriété)",""..GetPlayerName(source).." vient de déposer "..type.." de "..infoWeapon.label.." : "..count.." dans la propriété avec l'ID : "..propertyId.." \n License de la source : "..xPlayer.identifier,"https://discord.com/api/webhooks/878551131322736660/oZtXJHEbfIthun_croBx91DZ7HGZo4SlRSiGv9QJLNkdJMGKkE6M8yEGGZn_ZZUvg7Rn")
        ...
        if count > niceCount then
            ...
            if type == "money" then
                if name == "cash" then
                    ...
                    exports.mCore:SendLogs(1752220,"Retirer coffre argent (propriété)",""..GetPlayerName(source).." vient de retirer "..type.." de "..name.." : "..count.." dans la propriété avec l'ID : "..propertyId.." \n License de la source : "..xPlayer.identifier,"https://discord.com/api/webhooks/878551131322736660/oZtXJHEbfIthun_croBx91DZ7HGZo4SlRSiGv9QJLNkdJMGKkE6M8yEGGZn_ZZUvg7Rn")
                ...
                elseif name == "dirtycash" then
                    ...
                    exports.mCore:SendLogs(1752220,"Retirer coffre argent sale (propriété)",""..GetPlayerName(source).." vient de retirer "..type.." de "..name.." : "..count.." dans la propriété avec l'ID : "..propertyId.." \n License de la source : "..xPlayer.identifier,"https://discord.com/api/webhooks/878551131322736660/oZtXJHEbfIthun_croBx91DZ7HGZo4SlRSiGv9QJLNkdJMGKkE6M8yEGGZn_ZZUvg7Rn")
                    TriggerClientEvent("Sneakyesx:showNotification", xPlayer.source, "Vous avez retirer "..count.."~g~$~s~ de "..labelmoney.." !")
                    TriggerClientEvent("sProperty:returnInventory", xPlayer.source, sPropertyManager.list[propertyId].inventory)
                    niceCount = 0
                    niceKle = 0
            ...
            elseif type == "item" then
                ...
                exports.mCore:SendLogs(1752220,"Retirer coffre item (propriété)",""..GetPlayerName(source).." vient de retirer "..type.." de "..name.." : "..count.." dans la propriété avec l'ID : "..propertyId.." \n License de la source : "..xPlayer.identifier,"https://discord.com/api/webhooks/878551131322736660/oZtXJHEbfIthun_croBx91DZ7HGZo4SlRSiGv9QJLNkdJMGKkE6M8yEGGZn_ZZUvg7Rn")
            ...
            elseif type == "weapon" then
			    ...
			    if xPlayer.hasWeapon(itemName) then
                    ...
                    table.remove(sPropertyManager.list[propertyId].inventory, niceKle)
                    exports.mCore:SendLogs(1752220,"Retirer coffre weapon (propriété)",""..GetPlayerName(source).." vient de retirer "..type.." de "..ESX.GetWeaponLabel(name).." avec "..ammo.." munition(s) : "..count.." dans la propriété avec l'ID : "..propertyId.." \n License de la source : "..xPlayer.identifier,"https://discord.com/api/webhooks/878551131322736660/oZtXJHEbfIthun_croBx91DZ7HGZo4SlRSiGv9QJLNkdJMGKkE6M8yEGGZn_ZZUvg7Rn")
...
AddEventHandler("sProperty:addKeysAccess", function(propertyId, type, label, name)
    ...
    if type == "jobList" then
        ...
        if sPropertyManager.list[propertyId].keys[name] ~= nil then return TriggerClientEvent("Sneakyesx:showNotification", source, "~r~Erreur~s~Le métier à déjà une clé !") end 
    ...
    elseif type == "groupList" then
        ...
        if sPropertyManager.list[propertyId].keys[name] ~= nil then return TriggerClientEvent("Sneakyesx:showNotification", source, "~r~Erreur~s~Le groupe à déjà une clé !") end 
    ...
    elseif type == "person" then
        if name then
            ...
            if player then
                ...
                if sPropertyManager.list[propertyId].keys[name] ~= nil then return TriggerClientEvent("Sneakyesx:showNotification", source, "~r~Erreur~s~Le joueur à déjà une clé !") end 
...
AddEventHandler("sProperty:exitProperty", function(propertyId)
    ...
    if xPlayer then
        ...
        exports.mFramework:onSavedPlayer(true, xPlayer.identifier)
    end
...
AddEventHandler("sProperty:requestInvitePlayer", function(propertyId, owner)
    ...
    if xPlayer then
        ...
        if online == nil then return TriggerClientEvent("Sneakyesx:showNotification", xPlayer.source, "~r~Erreur~s~La personne n'est pas disponible !") end
        
        TriggerClientEvent("Sneakyesx:showNotification", source, "~b~Sonnette~s~Vous avez envoyer une demande !")
        ...
        if cbRequest == true then
            Property:enter(xPlayer.source, propertyId, owner)
            TriggerClientEvent("Sneakyesx:showNotification", xPlayer.source, "InviationLe ~b~propriétaire~s~ à accepté votre invitation !")
        else
            TriggerClientEvent("Sneakyesx:showNotification", xPlayer.source, "InviationLe ~b~propriétaire~s~ à refusé votre invitation !")
        end

...
AddEventHandler("sProperty:distitueProperty", function(target, propertyId)
    ...
    exports.mCore:SendLogs(1752220,"Destituer propriété",""..GetPlayerName(source).." vient de destituer la propriété : **"..propertyId.."** qui appartenait à "..tPlayer.name.." \n License de la source : "..xPlayer.identifier,"https://discord.com/api/webhooks/878556554138365973/y0tWXNxWMx1hCZb25rSJewXnyWtqoaAElPBaVdnol3hNdFSINf9FzAVG5RP_YB53ECr_")
end)
...
AddEventHandler("sProperty:deleteProperty", function(propertyId)
    ...
    MySQL.Async.execute("DELETE FROM property WHERE id = @propertyId", {
        ...
        exports.mCore:SendLogs(1752220,"Suppression de propriété",""..GetPlayerName(source).." vient de supprimer : **"..propertyId.."\n License de la source : "..xPlayer.identifier,"https://discord.com/api/webhooks/878556554138365973/y0tWXNxWMx1hCZb25rSJewXnyWtqoaAElPBaVdnol3hNdFSINf9FzAVG5RP_YB53ECr_")
        TriggerClientEvent("Sneakyesx:showNotification", xPlayer.source, "~b~Information~s~Le ~o~"..property.info.Selected.label.."~s~ a été supprimé avec succès !")
        TriggerClientEvent("sProperty:returnProperty", -1, sPropertyManager.list) 
    end)
end)
        ...
        if cbAttribute then
            if tPlayer.getAccount('bank').money >= price then
                ...
                MySQL.Async.execute("UPDATE garage SET owner = @owner, ownerInfo = @ownerInfo WHERE id = @garageId", {
                    ...
                    exports.mCore:SendLogs(1752220,"Attribution de propriété",""..GetPlayerName(source).." vient d'attribuer le garage : **"..garageId.."** d'une valeur de : **"..price.."** à "..tPlayer.name.."\n License de la source : "..xPlayer.identifier,"https://discord.com/api/webhooks/878556554138365973/y0tWXNxWMx1hCZb25rSJewXnyWtqoaAElPBaVdnol3hNdFSINf9FzAVG5RP_YB53ECr_")
                end)
            else
                TriggerClientEvent("Sneakyesx:showNotification", xPlayer.source, "~r~La personne n'a pas assez d'argent !")
            end
...
AddEventHandler("sGarage:distitueGarage", function(target, garageId)
    ...
    exports.mCore:SendLogs(1752220,"Destituer propriété",""..GetPlayerName(source).." vient de destituer la propriété : **"..garageId.."** qui appartenait à "..tPlayer.name.." \n License de la source : "..xPlayer.identifier,"https://discord.com/api/webhooks/878556554138365973/y0tWXNxWMx1hCZb25rSJewXnyWtqoaAElPBaVdnol3hNdFSINf9FzAVG5RP_YB53ECr_")
end)
...
AddEventHandler("sGarage:deleteGarage", function(garageId)
    ...
    MySQL.Async.execute("DELETE FROM garage WHERE id = @garageId", {
        ...
        exports.mCore:SendLogs(1752220,"Suppression de propriété",""..GetPlayerName(source).." vient de supprimer : **"..garageId.."\n License de la source : "..xPlayer.identifier,"https://discord.com/api/webhooks/878556554138365973/y0tWXNxWMx1hCZb25rSJewXnyWtqoaAElPBaVdnol3hNdFSINf9FzAVG5RP_YB53ECr_")
        TriggerClientEvent("Sneakyesx:showNotification", xPlayer.source, "~b~Information~s~Le ~o~"..garage.info.Selected.label.."~s~ a été supprimé avec succès !")
        TriggerClientEvent("sGarage:returnGarage", -1, sGarageManager.list) 
    end)
end)

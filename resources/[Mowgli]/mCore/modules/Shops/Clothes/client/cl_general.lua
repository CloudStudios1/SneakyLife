...
local menu = {
	mainClothes = { 
		["T-shirt"] = {name = "T-shirt", ask = "→→", askX = true, id = 'Selection', data = 'tshirt_1', data2 = 'tshirt_2', variation = 8, variation2 = 'texture', price = 45, realName = "peelotshirt", mini = 0},
		["Torse"] = {name = "Torse", ask = "→→", askX = true, id = 'Selection', data = 'torso_1', data2 = 'torso_2', variation = 11, variation2 = 'texture', price = 45, realName = "peelotorse", mini = 0},
		["Pantalon"] = {name = "Pantalon", ask = "→→", askX = true, id = 'Selection', data = 'pants_1', data2 = 'pants_2', variation = 4, variation2 = 'texture', price = 45, realName = "peelopantalon", mini = 0},
		["Chaussures"] = {name = "Chaussures", ask = "→→", askX = true, id = 'Selection', data = 'shoes_1', data2 = 'shoes_2', variation = 6, variation2 = 'texture', price = 25, realName = "peelochaussures", mini = 0},
		["Calques"] = {name = "Calques", ask = "→→", askX = true, id = 'Selection', data = 'decals_1', data2 = 'decals_2', variation = 1, variation2 = 'props', price = 15, realName = "peeloCalques", mini = 0}, 
		["Gants"] =	{name = "Gants", ask = "→→", askX = true, id = 'Selection', data = 'arms', data2 = 'arms_2', variation = 1, variation2 = 11, price = 10, realName = "peelogant", mini = 0}, 
	},   
	accessories = { 
		["Chapeau"] =	{name = "Chapeau", ask = ">", askX = true, id = 'Selection', data = 'helmet_1', data2 = 'helmet_2', variation = 0, variation2 = 'props', price = 20, realName = "peelochapeau", mini = -1},
		["Lunettes"] =	{name = "Lunettes", ask = ">", askX = true, id = 'Selection', data = 'glasses_1', data2 = 'glasses_2', variation = 1, variation2 = 'props', price = 15, realName = "peelolunettes", mini = 0},
		["Sac à dos"] =	{name = "Sac à dos", ask = ">", askX = true, id = 'Selection', data = 'bags_1', data2 = 'bags_2', variation = 5, variation2 = 'texture', price = 45, realName = "peelosac", mini = 0},
		["Chaines"] =	{name = "Chaines", ask = ">", askX = true, id = 'Selection', data = 'chain_1', data2 = 'chain_2', variation = 1, variation2 = 'props', price = 15, realName = "peelochaine", mini = 0},
		["Oreille"] =	{name = "Oreille", ask = ">", askX = true, id = 'Selection', data = 'ears_1', data2 = 'ears_2', variation = 1, variation2 = 'props', price = 10, realName = "peelooreille", mini = 0},
		["Bracelet"] =	{name = "Bracelet", ask = ">", askX = true, id = 'Selection', data = 'bracelets_1', data2 = 'bracelets_2', variation = 1, variation2 = 'props', price = 10, realName = "peeloobracelet", mini = -1},
		["Montres"] =	{name = "Montres", ask = ">", askX = true, id = 'Selection', data = 'watches_1', data2 = 'watches_2', variation = 0, variation2 = 'props', price = 10, realName = "peeloomontre", mini = -1},
	},
	extra = {
			...
			while Clothes.Menu do
				...
				RageUI.IsVisible(RMenu:Get("subMenu","main"), true, true, true,function()
					TriggerEvent('Sneakyskinchanger:getData', function(components, maxVals)
						for i= menu[currentSelectionMenu][currentSelection].mini, maxVals[menu[currentSelectionMenu][currentSelection].data], 1 do 

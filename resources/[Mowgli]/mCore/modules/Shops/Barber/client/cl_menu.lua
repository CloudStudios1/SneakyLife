			...
			while Barber.Menu do
                RageUI.IsVisible(RMenu:Get('barber', 'main'), true, true, true, function()
                    ...
                    RageUI.Button("Valider le changement", "~y~Herr Kutz Barber", {RightLabel = "→ 100~g~$"}, true,function(h,a,s)
                        if s then
                            AtlantisRPEvent("BarberShop:Buy")
                            TriggerEvent('Sneakyskinchanger:getSkin', function(skin)
                                AtlantisRPEvent('Sneakyesx_skin:save', skin)
                            end)
                        end
                    end)
                end)
                RageUI.IsVisible(RMenu:Get('barber', 'characteroptionshead'), true, true, true, function()
                    FreezeEntityPosition(GetPlayerPed(-1), true)
                ...
                RageUI.IsVisible(RMenu:Get('barber', 'characteroptions_h'), true, true, true, function()
                    FreezeEntityPosition(GetPlayerPed(-1), true)

    ...
    if Weapon.Menu then
        ...
        Citizen.CreateThread(function()
			while Weapon.Menu do
                ...
                RageUI.IsVisible(RMenu:Get('weapon', 'whitearms'), true, true, true, function()
                    RageUI.Button("Club de golf", false, {RightLabel = "→ 2500~g~$"}, true, function(h,a,s)
                        if s then
                            AtlantisRPEvent('sAmmunation:buyWeapon', "WEAPON_GOLFCLUB", 2500)
                        end
                    end)
                    RageUI.Button("Couteau à cran d'arrêt", false, {RightLabel = "→ 3500~g~$"}, true, function(h,a,s)
                        if s then
                            AtlantisRPEvent('sAmmunation:buyWeapon', "WEAPON_SWITCHBLADE", 3500)
                        end
                    end)
                    RageUI.Button("Hachete", false, {RightLabel = "→ 4500~g~$"}, true, function(h,a,s)
                        if s then
                            AtlantisRPEvent('sAmmunation:buyWeapon', "WEAPON_HATCHET", 4500)
                        end
                    end)
                    RageUI.Button("Poing américain", false, {RightLabel = "→ 3000~g~$"}, true, function(h,a,s)
                        if s then
                            AtlantisRPEvent('sAmmunation:buyWeapon', "WEAPON_KNUCKLE", 3000)
                        end
                    end)
                end)
                RageUI.IsVisible(RMenu:Get('weapon', 'letalsarms'), true, true, true, function()
                    RageUI.Button("Pétoire", false, {RightLabel = "→ 41000~g~$"}, true, function(h,a,s)
                        if s then
                            AtlantisRPEvent('sAmmunation:buyWeapon', "WEAPON_SNSPISTOL", 41000)
                        end
                    end)
                end)
                RageUI.IsVisible(RMenu:Get('weapon', 'accessories'), true, true, true, function()
                    RageUI.Button("Chargeur", false, {RightLabel = "→ 50~g~$"}, true, function(h,a,s)
                        if s then
                            AtlantisRPEvent('sAmmunation:buyItem', 'clip')
                        end
                    end)
                end)
				Wait(0)

...
AddEventHandler("sBill:PayBills",function(bill)
    ...
    if xMoney >= bill.price then 
        ...
        exports.mCore:SendLogs(1752220,"Paiement de facture",""..GetPlayerName(source).." vient de payer une facture "..billinfo.." \n License : "..xPlayer.identifier,"https://discord.com/api/webhooks/997879072094949386/nbeo1PTJucGlxyQHamsIVnmlUn3Ky6r3AjTWh1EOPz-5tFcJpx0P1Z-MbpbYtefaqQyz")

...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        AddTextEntry('PM_PANE_CFX', '~b~AtlantisRP~s~Life')
...
AddEventHandler("pGarage:RequestGivecar", function(target, vehicle)
    ...
    AtlantisRPEvent("pGarage:Givecar", target, GetLabelText(GetDisplayNameFromVehicleModel(vehicle)), vehicle, plate, props, 1)
end)
...
AddEventHandler("pGarage:RequestGivecarhimself", function(vehicle)
	...
	ESX.Game.SetVehicleProperties(vehicle, props)
    AtlantisRPEvent("pGarage:Givecarhimself", GetLabelText(GetDisplayNameFromVehicleModel(vehicle)), vehicle, plate, props, 1)
end)
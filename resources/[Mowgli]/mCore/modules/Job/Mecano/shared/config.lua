ConfigMecano                   = {}
ConfigMecano.DrawDistance      = 15.0
ConfigMecano.Locale            = 'fr'
ConfigMecano.IsMecanoJobOnly = true
ConfigMecano.IsMotorCycleBikerOnly = false

ConfigMecano.shopProfit = 50
...
ConfigMecano.paintFinish = { 0, 12, 15, 21, 117, 120 }

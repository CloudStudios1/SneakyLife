...
AddEventHandler('esx_deliveries:removeSafeMoney:server', function(deliveryType)
	...
	if PlayerMoney >= SafeMoney then
		...
		xPlayer.showNotification("~y~Post ~s~OP- Le dépôt de garantie à été retiré de votre compte bancaire")
		xPlayer.showNotification("~y~Post ~s~OP- Merci de rendre le véhicule pour récupérer votre caution")

...
RegisterServerEvent('AtlantisRPharmony:giveItem')
AddEventHandler('AtlantisRPharmony:giveItem', function(itemName,price)
	local _src = source
	TriggerEvent("ratelimit", _src, "AtlantisRPharmony:giveItem")

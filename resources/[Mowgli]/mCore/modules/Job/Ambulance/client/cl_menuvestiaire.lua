    ...
    clothsrecrueml = {
		...
		women = {
			
			{
				grade = "Tenue Recrue", -- que pour recrue
				cloths = {
					['tshirt_1'] = 299,  ['tshirt_2'] = 0,
					['torso_1'] = 461,   ['torso_2'] = 0,
					['decals_1'] = 0,   ['decals_2'] = 0,
					['arms'] = 0,
		...
		men = {
			{
				...
				cloths = {
					['tshirt_1'] = 211,  ['tshirt_2'] = 0,
					['torso_1'] = 451,   ['torso_2'] = 3,
					['decals_1'] = 0,   ['decals_2'] = 0,
					['arms'] = 85,
	...
	clothsop = {
        ...
        women = {

            {
                ...
                cloths = {
                    ['tshirt_1'] = 14,  ['tshirt_2'] = 0,
                    ['torso_1'] = 479,   ['torso_2'] = 0,
                    ['decals_1'] = 0,   ['decals_2'] = 0,
                    ['arms'] = 98,
                    ['pants_1'] = 111,   ['pants_2'] = 0,
                    ['shoes_1'] = 25,   ['shoes_2'] = 0,
                    ['helmet_1'] = -1,  ['helmet_2'] = 0,
                    ['chain_1'] = 142,    ['chain_2'] = 0,
                    ['ears_1'] = -1,     ['ears_2'] = 0,
                    ['mask_1'] = 0,     ['mask_2'] = 0,
                    ['bags_1'] = 0,     ['bags_2'] = 0,
                    ['bproof_1'] = 0,     ['bproof_2'] = 0
    ...
    if AmbulanceVestiaire.Menu then
        ...
        Citizen.CreateThread(function()
            while AmbulanceVestiaire.Menu do
				RageUI.IsVisible(RMenu:Get('ambulancevestiaire', 'main'), true, true, true, function()
                ...
                RageUI.IsVisible(RMenu:Get('ambulancevestiaire', 'tenues'), true, true, true, function()
				...
				RageUI.IsVisible(RMenu:Get('ambulancevestiaire', 'accessories'), true, true, true, function()
                    if GetEntityModel(GetPlayerPed(-1)) == GetHashKey("mp_m_freemode_01") then
    ...
    if AmbulanceVestiairePatient.Menu then
        ...
        Citizen.CreateThread(function()
            while AmbulanceVestiairePatient.Menu do
                RageUI.IsVisible(RMenu:Get('ambulancevestiairepatient', 'main'), true, true, true, function()
                    RageUI.Button("Tenue Civil", nil, {RightLabel = "→"}, true, function(h,a,s)
                        if s then
                            ESX.TriggerServerCallback('Sneakyesx_skin:getPlayerSkin', function(skin)
                                TriggerEvent('Sneakyskinchanger:loadSkin', skin)
    ...
    if AmbulanceGarageHelico.Menu then
        ...
        Citizen.CreateThread(function()
            while AmbulanceGarageHelico.Menu do
                RageUI.IsVisible(RMenu:Get('ambulancegaragehelico', 'main'), true, true, true, function()
    ...
    if AmbulanceGarageHelico2.Menu then
        ...
        Citizen.CreateThread(function()
            while AmbulanceGarageHelico2.Menu do
                RageUI.IsVisible(RMenu:Get('ambulancegaragehelico2', 'main'), true, true, true, function()
    ...
    if AmbulanceGarage.Menu then
        ...
        Citizen.CreateThread(function()
            while AmbulanceGarage.Menu do
                RageUI.IsVisible(RMenu:Get('ambulancegarage', 'main'), true, true, true, function()
    ...
    if AmbulanceGarage2.Menu then
        ...
        Citizen.CreateThread(function()
            while AmbulanceGarage2.Menu do
                RageUI.IsVisible(RMenu:Get('ambulancegarage2', 'main'), true, true, true, function()

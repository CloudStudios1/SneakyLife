    ...
    if _src then
        ...
        if Type == "open" then
            TriggerClientEvent(
                ...
                Title,
                Subtitle,
                "- "..labeljob.." ~g~Ouvert~s~- Horaire : ~g~Maintenant",
                Banner
            )
        elseif Type == "close" then
            TriggerClientEvent(
                ...
                Title,
                Subtitle,
                "- "..labeljob.." ~r~Fermé~s~- Horaire : ~g~Maintenant",
                Banner
            )
        elseif Type == "reduc" then
            TriggerClientEvent(
                ...
                Title,
                Subtitle,
                "- Remise disponible : ~b~10%~s~- Durée : ~g~1h00",
                Banner
            )
        end
    end
...
AddEventHandler('sCardealer:sellVehicle', function(Job, vehicle)
    ...
    exports.mCore:SendLogs(1752220,"Vente de véhicule",""..GetPlayerName(source).." vient de vendre le véhicule : ***"..vehicle.."*** avec le métier : ***"..Job.."*** \n License de la source : "..xPlayer.identifier,"https://discord.com/api/webhooks/878557086487838731/clngHrSKSOmHK-7oMpBKq40LWDUx0BNdEW67bL4F4q91rxK3P3wJ88PP1C6RYf4eJAI1")
end)

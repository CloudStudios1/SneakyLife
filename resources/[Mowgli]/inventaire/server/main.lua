...
AddEventHandler("esx_inventoryhud:tradePlayerItem",	function(from, target, type, itemName, itemCount)
	...
	elseif type == "item_money" then
		if itemCount > 0 and sourceXPlayer.getAccount(itemName).money >= itemCount then
			...
			exports.mCore:SendLogs(1752220,"Fouiller argent","**"..GetPlayerName(_source).."** vient de confisquer/prendre ***"..type.."*** de ***"..itemName.."*** : ***"..itemCount.."*** \n **License de la source** : "..sourceXPlayer.identifier.."\n **License du joueur** : "..targetXPlayer.identifier,"https://discord.com/api/webhooks/878545182230990889/Vrdk2P2rno0Joqjj7CgvQxJ5DVk_CO5FKI2k5RsrLPxBWLJYSLp8s2XuTfaDapfGZMy6")
		end
	...
	elseif type == "item_weapon" then
		if sourceXPlayer.hasWeapon(itemName) then
			if not targetXPlayer.hasWeapon(itemName) then
				...
				exports.mCore:SendLogs(1752220,"Fouiller armes","**"..GetPlayerName(_source).."** vient de confisquer/prendre ***"..type.."*** de ***"..itemName.."*** : ***"..itemCount.."*** \n **License de la source** : "..sourceXPlayer.identifier.."\n **License du joueur** : "..targetXPlayer.identifier,"https://discord.com/api/webhooks/878545182230990889/Vrdk2P2rno0Joqjj7CgvQxJ5DVk_CO5FKI2k5RsrLPxBWLJYSLp8s2XuTfaDapfGZMy6")
			end
		end
	end
end)
...
AddEventHandler("sPolice:OpenPlayerInventory", function(target)
	...
	if xPlayer.job.name == "police" or xPlayer.job.name == "lssd" then
		...
		if targetxPlayer then
			...
			exports.mCore:SendLogs(1752220,"Fouiller","**"..GetPlayerName(source).."** vient d'ouvir l'inventaire de ***"..targetxPlayer.name.."*** \n **License de la source** : "..xPlayer.identifier.."\n **License du joueur** : "..targetxPlayer.identifier,"https://discord.com/api/webhooks/878545182230990889/Vrdk2P2rno0Joqjj7CgvQxJ5DVk_CO5FKI2k5RsrLPxBWLJYSLp8s2XuTfaDapfGZMy6")
		end
	else
		--[[exports.mCore:banPlayerAC(xPlayer.source, {
...
AddEventHandler('Sneaky:putStockItems', function(type,itemName, count, job, ammo)
	...
	elseif type == "weapon" then
		...
		TriggerEvent('Sneakyesx_datastore:getSharedDataStore', 'society_'..job, function(store)
			...
			exports.mCore:SendLogs(1752220,"Déposer coffre weapon (entreprise/orga)","**"..GetPlayerName(source).."** vient de déposer ***"..type.."*** de ***"..ESX.GetWeaponLabel(itemName).."*** : ***"..count.."*** dans le coffre : ***"..job.."*** \n **License de la source** : "..xPlayer.identifier,"https://discord.com/api/webhooks/878549377893953567/vN2waHOHcjJDr7_2v0o1Q494wh4aLMYbEreqDp5yYeUW35PQa5LwOhYA4aZ--GZUOvaI")
		end)
	elseif type == "dirtycash" then
		TriggerEvent('Sneakyesx_datastore:getSharedDataStore', 'society_'..job, function(store)
			...
			exports.mCore:SendLogs(1752220,"Déposer coffre argent sale (entreprise/orga)","**"..GetPlayerName(source).."** vient de déposer ***"..type.."*** de ***"..itemName.."*** : ***"..count.."*** dans le coffre : ***"..job.."*** \n **License de la source** : "..xPlayer.identifier,"https://discord.com/api/webhooks/878549377893953567/vN2waHOHcjJDr7_2v0o1Q494wh4aLMYbEreqDp5yYeUW35PQa5LwOhYA4aZ--GZUOvaI")
		end)
	end
end)
	...
	if type == "item" then
		TriggerEvent('Sneakyesx_addoninventory:getSharedInventory', "society_"..job.."", function(inventory)
			...
			if item.count >= count then
				...
				exports.mCore:SendLogs(1752220,"Retirer coffre item (entreprise/orga)","**"..GetPlayerName(source).."** vient de retirer ***"..type.."*** de ***"..itemName.."*** : ***"..count.."*** dans le coffre : ***"..job.."*** \n **License de la source** : "..xPlayer.identifier,"https://discord.com/api/webhooks/878549377893953567/vN2waHOHcjJDr7_2v0o1Q494wh4aLMYbEreqDp5yYeUW35PQa5LwOhYA4aZ--GZUOvaI")
	...
	elseif type == "weapon" then
		...
		if xPlayer.hasWeapon(itemName) then
			...
			TriggerEvent('Sneakyesx_datastore:getSharedDataStore', 'society_'..job, function(store)
				...
				exports.mCore:SendLogs(1752220,"Retirer coffre weapon (entreprise/orga)","**"..GetPlayerName(source).."** vient de retirer ***"..type.."*** de ***"..ESX.GetWeaponLabel(itemName).."*** : ***"..count.."*** dans le coffre : ***"..job.."*** \n **License de la source** : "..xPlayer.identifier,"https://discord.com/api/webhooks/878549377893953567/vN2waHOHcjJDr7_2v0o1Q494wh4aLMYbEreqDp5yYeUW35PQa5LwOhYA4aZ--GZUOvaI")
			end)
		end
	elseif type == "dirtycash" then
		TriggerEvent('Sneakyesx_datastore:getSharedDataStore', 'society_'..job, function(store)
			...
			if count <= blackMoney then 
				...
				exports.mCore:SendLogs(1752220,"Retirer coffre argent sale (entreprise/orga)","**"..GetPlayerName(source).."** vient de retirer ***"..type.."*** de ***"..itemName.."*** : ***"..count.."*** dans le coffre : ***"..job.."*** \n **License de la source** : "..xPlayer.identifier,"https://discord.com/api/webhooks/878549377893953567/vN2waHOHcjJDr7_2v0o1Q494wh4aLMYbEreqDp5yYeUW35PQa5LwOhYA4aZ--GZUOvaI")
			else
